...
public class Tramo {
	...
	private static int ANCHOAUTO     =   10;	
       ...
       * @param velocidadEl parametro velocidad est� en KM/H, y es la sugerida por la Onda Verde para que transiten los autos.
       */
      public synchronized void cicloTrafico(int tiempo){
    	  ...
    	  for(Iterator<Auto> i = autosTrafico.iterator(); i.hasNext(); ){
        	  ...
        	  /* Evaluo si el auto lleg� al final del tramo, si el semaforo permite pasar y 
       ...
       * Reinicia sus datos de posici�n, y le setea la velocidad recomendada por la Onda Verde.
       */
